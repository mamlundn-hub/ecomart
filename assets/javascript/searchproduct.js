...
let galleryArray = [
  ...
  {
    id: 2,
    name: "Bình inox cao cấp",
    src: "assets/img/binhinox.webp",
    desc: "Chất liệu inox 304 cao cấp, an toàn cho sức khỏe, có thể giữ nhiệt lâu và tái sử dụng nhiều lần.",
    price: 350,
  },
  {
    id: 3,
            ...
            <div class="category__item">
                ...
                <div class="category__item-info">
                    ...
                    <div class="category__item-interact">
                        ...
                        <button class="category__item-cart" id="cart_${curArray[i].id}">
...
galleryArray.forEach((value) => {
  document.getElementById(`cart_${value.id}`).onclick = () => {
